  ...
  return(
    <>
      ...
      <div className="mx-auto flex justify-center">
        <div className="bg-white fixed rounded-20 shadow-primaryShadow lg:w-525 lg:h-757 w-9 h-auto top-5 mx-auto z-50 pb-4">
          ...
          <div className="px-10 mt-5">
            ...
            <div className="lg:w-418 lg:text-24 text-18 font-RatDisplay text-lightGray leading-8 mt-2">High Quality Palm & Almon Nuts, grown in the beautiful Planes of Jos Plateau.</div>
            ...
            <div className="flex justify-end mt-3 lg:mt-0">
              ...
              <button className="w-172 lg:h-60 rounded-full bg-primaryBlue text-white lg:text-24 text-18">Buy Now</button>
            </div>
          </div>
          </>
        }
