  ...
  return(
    <>
      ...
      <div className="mx-auto flex justify-center">
        <div className="bg-white fixed rounded-20 shadow-primaryShadow lg:w-525 w-9 h-auto top-10 mx-auto z-50 pb-4">
          ...
          <div className="px-10 mt-5">
            ...
            <div className="lg:w-418 text-18 font-RatDisplay text-lightGray leading-8 mt-2">High Quality Palm & Almon Nuts, grown in the beautiful Planes of Jos Plateau.</div>
            ...
            <div className="flex justify-end mt-3 lg:mt-0">
              <div className="font-RatDisplay font-500 text-18 whitespace-nowrap items-center flex mr-4 text-lightGray">Add to Cart <span className="ml-2"><CartIcon /></span></div>
              <button className="w-172 p-2 rounded-full bg-primaryBlue text-white text-18">Buy Now</button>
            </div>
          </div>
          </>
        }
